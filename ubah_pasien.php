...
<?php 
    ...
    $query2 = "SELECT * FROM tb_poli WHERE kd_poli='".$kd_poli."'";
      ...
      <div class="card-body">
            <form  role="form" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <h5 class="card-inside-title">Nama Pasien</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nm_pasien" class="form-control" value="<?php echo $data['nm_pasien']; ?>" />
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea rows="1" name="alamat" class="form-control no-resize auto-growth"><?php echo $data['alamat']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <h5 class="card-inside-title">Id Dokter</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="id_dokter" class="form-control" id="id_dokter" value="<?php echo $data['id_dokter']; ?>" />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Nama Dokter</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nm_dokter" class="form-control" id="nm_dokter" value="<?php echo $data['nm_dokter']; ?>" />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Kd Poli</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="kd_poli" class="form-control" id="kd_poli" value="<?php echo $data['kd_poli']; ?>" />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Nama Poli</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nm_poli" class="form-control" id="nm_poli" value="<?php echo $data2['nm_poli']; ?>" />
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                        <div class="form-line">
                                            <div class="form-line">
                                                <input type="date" name="terdaftar" class="form-control date" value="<?php echo $data['terdaftar']; ?>"/>
                                            </div>
                                        </div>
                            </div>
  <div class="form-group pull-right">
    <a href="data_pasien.php" class="btn btn-danger"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
...
if (isset($_POST['submit'])) {
    ...
    $id_dokter          =$_POST['id_dokter'];
        ...
        $query = "UPDATE tb_pasien SET nm_pasien ='".$nm_pasien."',jenis_kelamin ='".$jenis_kelamin."',alamat ='".$alamat."',umur ='".$umur."',nm_dokter ='".$nm_dokter."',kd_poli ='".$kd_poli."',id_dokter ='".$id_dokter."',terdaftar ='".$terdaftar."' WHERE id_pasien='".$id_pasien."'";
  ...
  if (mysqli_affected_rows($conn) > 0) {
    ...
    echo "<script>
            ...
            document.location.href='ubah_pasien.php'
              </script>
          ";
  }
}
