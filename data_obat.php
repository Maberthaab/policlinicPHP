...
<body id="page-top">
  ...
  <div id="wrapper">
        ...
        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTabl">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                        $query="SELECT * FROM tb_obat"; //query menampilkan data
                ...
                <tr>
                    ...
                    <td>
                    <a href='ubah_obat.php?kd_obat=<?php echo $data['kd_obat'];?>'  class="btn btn-primary"><i class="fa fa-pencil"></i> Ubah</a>
                    <a href='hapus_dokter.php?kd_obat=<?php echo $data['kd_obat'];?>' 
    ...
    <a href="stok_obat.php" class="btn btn-primary"><i class="fas fa-arrow-circle-right"></i>Tambah Stok Obat</a>
  </div>
                        </div><br>
        <!-- Icon Cards-->
<h2 class="card-inside-title" style="color: black;" >Tambah Obat</h2><br>
...
$query = "INSERT INTO tb_obat VALUES ('$kd_obat','$nm_obat','$jenis_obat','$stok','$tarif')";
