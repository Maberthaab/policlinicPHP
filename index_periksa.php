<?php 
  ...
  $cari=$_POST['cari'];
    ...
    $query3 = "SELECT * FROM tb_poli WHERE kd_poli='".$kd_poli."'";
    $hasil3 = mysqli_query($conn,$query3);
    $data3 = mysqli_fetch_array($hasil3);

    $nm_poli        =$data3['nm_poli'];

    $query2 = "SELECT max(id_pemeriksaan) as maxKode FROM tb_pemeriksaan";
...
<form  role="form" action="" method="POST">
                            ...
                            <h5 class="card-inside-title">ID Pemeriksaan</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="id_pemeriksaan" class="form-control" value="<?php echo $idBel; ?>" readonly />
                                        </div>
                                    </div>
...
<!---------Hidden----------------------><div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="id_pasien" value="<?php echo $id_pasien; ?>" hidden readonly />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Poli</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nm_poli" class="form-control" id="nm_poli" value="<?php echo $nm_poli; ?>" readonly />
                                        </div>
                                    </div>
<!---------Hidden----------------------><div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="kd_poli" value="<?php echo $kd_poli; ?>" hidden readonly />
                                        </div>
                                    </div>
...
<!---------Hidden----------------------><div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="id_dokter" value="<?php echo $id_dokter; ?>" hidden readonly />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Keluhan</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="keluhan" class="form-control" />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Diagnosa</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="diagnosa" class="form-control" />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Tanggal Pemeriksaan</h5>
...
$query = "INSERT INTO tb_pemeriksaan VALUES ('$id_pemeriksaan','$id_pasien','$nm_pasien','$id_dokter','$kd_poli','$nm_poli','$nm_dokter','$keluhan','$diagnosa','$tgl_periksa')";
  ...
  if (mysqli_affected_rows($conn) > 0) {
    ...
    echo "<script>
            ...
            document.location.href='cetak_resep.php?id_pemeriksaan=$idBel'
              </script>
          ";
  }else{
    echo "<script>
