  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav" style="background-color: #000A4D;">
      <li class="nav-item active">
        <a class="nav-link" href="data_periksa.php">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card-body">
          <form action="cetak_filter_pemeriksaan.php" method="POST">
            <div class="row">
              <div class="col-md-3">
                <label>Dari</label>
              ...
              <button type="submit" class="btn btn-primary" name="tanpilkan" style="float: bottom; height: 38px; margin-top: 32px;">cetak</button>
            </div>
          </form><br>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTabl">
                                ...
                                <tbody>
                                    <?php 
                    include "koneksi.php";
                        $query="SELECT * FROM tb_pemeriksaan"; //query menampilkan data
