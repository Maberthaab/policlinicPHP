    ...
    <div id="content-wrapper">
      ...
      <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTabl">
                                ...
                                <tbody>
                                    <?php 
                    include "koneksi.php";
                        $query="SELECT * FROM tb_pasien"; //query menampilkan data
                ...
                <tr>
                    ...
                    <td>
                    <a href='ubah_pasien.php?id_pasien=<?php echo $data['id_pasien'];?>'  class="btn btn-primary"><i class="fa fa-pencil"></i> Ubah</a>
                    <a href='hapus_pasien.php?id_pasien=<?php echo $data['id_pasien'];?>' 
