  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav" style="background-color: #000A4D;">
      <li class="nav-item active">
        <a class="nav-link" href="ubah_obat.php">
...
<?php 
             ...
             $query="SELECT * FROM tb_obat WHERE kd_obat='$kd_obat'";
                          ...
                          <form  role="form" action="" method="POST">
                            <h5 class="card-inside-title">KD Obat</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="kd_obat" class="form-control" value="<?php echo $pecah['kd_obat']; ?>"  readonly />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Nama Obat</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nm_obat" class="form-control" value="<?php echo $pecah['nm_obat']; ?>" />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Jenis Obat</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="jenis_obat" class="form-control" value="<?php echo $pecah['jenis_obat']; ?>" />
                                        </div>
                                    </div>
                            <h5 class="card-inside-title">Stok</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="stok" class="form-control" value="<?php echo $pecah['stok']; ?>" readonly />
                                        </div>
                                    </div>
...
if (isset($_POST['submit'])) {
  ...
  $query="UPDATE tb_obat SET kd_obat='$kd_obat',nm_obat='$nm_obat',jenis_obat='$jenis_obat',stok='$stok',tarif='$tarif' WHERE kd_obat='$kd_obat'";
  ...
  if (mysqli_affected_rows($conn) > 0) {
    ...
    echo "<script>
            ...
            document.location.href='ubah_obat.php'
              </script>
          ";
  }
}
