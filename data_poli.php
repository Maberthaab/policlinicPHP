        ...
        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTabl">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                        $query="SELECT * FROM tb_poli"; //query menampilkan data
                ...
                <tr>
                    ...
                    <td>
                    <a href='ubah_poli.php?kd_poli=<?php echo $data['kd_poli'];?>'  class="btn btn-primary"><i class="fa fa-pencil"></i> Ubah</a>
                    <a href='hapus_poli.php?kd_poli=<?php echo $data['kd_poli'];?>' 
        ...
        <!-- Area Chart Example-->
                        <div class="body">
                          <form  role="form" action="" method="POST">
                            <h2 class="card-inside-title">Tambah Poli</h2><br>
                            <h5 class="card-inside-title">KD Poli</h5>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="kd_poli" class="form-control" value="<?php echo $idBel; ?>"  readonly />
                                        </div>
                                    </div>
...
$query = "INSERT INTO tb_poli VALUES ('$kd_poli','$nm_poli')";
